...
public class Lab5Task {
    ...
    private static int generateOTP() {
        ...
        for (int i = 0; i < numberOfDigitsInOTP; i++) {
            ...
            int powersOfTenVariables = (int) Math.pow(10.0, i);
            powersOfTenVariables = randomNumber * powersOfTenVariables;
            oneTimePassword = oneTimePassword + powersOfTenVariables;
        }
